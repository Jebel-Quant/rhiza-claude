#!/usr/bin/env bash
# Bash completion for make targets, shipped with the rhiza Claude Code plugin.
#
# Install it with `/rhiza:completions` (or `--shell bash`), which copies this file to
# ${XDG_DATA_HOME:-$HOME/.local/share}/bash-completion/completions/make.
#
# To wire it up by hand instead, source it from ~/.bashrc:
