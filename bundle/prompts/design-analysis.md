> **Portable copy of `plugin/prompts/design-analysis.md`, generated by
...
scoping rule in `bundle/prompts/scorecard.md`. A synced file's complexity is upstream's problem.

**Gather, don't judge.** Produce evidence and let `bundle/prompts/scorecard.md` turn it into
...
`bundle/prompts/scorecard.md` lists subcategories that no gate measures either — test design
