> **Portable copy of `plugin/prompts/known-issues.md`, generated by
...
normally and follow `bundle/prompts/scorecard.md`.
...
superseded those with the SPDX `license` field that `bundle/prompts/license.md` writes.
